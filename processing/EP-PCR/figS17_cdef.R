...
outpath <- "~/work/yachie/Konno_FRACTAL/Revise round 1//Figures/FigS17 - PCR/BET002_filtered/"
outrds <- "~/work/yachie/Konno_FRACTAL/Revise round 1//data/Yusuke/epPCR_reanalysis/RDS/bet002_filtered//"
treepath <- "bet002_unaligned/dfs_15000_nolength/bet002_unaligned_nolength_15000tipsNode.filteredTree.rds"
...
count_table <-readRDS("bet002_unaligned//dfs_15000_nolength/bet002_unaligned_nolength_15000tipsNode.count_table.rds")
count_long <- readRDS("bet002_unaligned/dfs_15000_nolength/bet002_unaligned_nolength_15000tipsNode.count_long.rds")
tree_list <-  readRDS("bet002_unaligned/dfs_15000_nolength/bet002_unaligned_nolength_tree_list.15000tipsNode.rds")
clade_entropy <- readRDS("bet002_unaligned/dfs_15000_nolength/bet002_unaligned_nolength_15000tipsNode.clade_entropy.rds")
clade_vec <- readRDS("bet002_unaligned/dfs_15000_nolength/bet002_unaligned_nolength_clade_vec.15000tipsNode.rds")
count_exp <- readRDS("bet002_unaligned/dfs_15000_nolength/bet002_unaligned_nolength_tbl_tree_expand.15000tipsNode.rds")
# 
...
# saveRDS(rand.color,"well.COLORCODE.96.unfiltered.thick.rds")
# rand.color <- readRDS("well.COLORCODE.96.unfiltered.thick.rds")
...
g2_all <- readRDS("bet002_unaligned///dfs_15000_nolength/tree_filtered_ggplot.rds")
# xlab("Upstream tree")+
...
ggsave(paste0(outpath,"/correspond_to_fig5c/","upstream_tree.tip15000.nolength.pdf"),g_merge_all,width = 11.6,height = 9.2,units = "cm")
ggsave(paste0(outpath,"/correspond_to_fig5c/","upstream_tree.tip15000.nolength.jpeg"),g_merge_all,width = 11.6,height = 9.2,units = "cm")
...
d <- readRDS(paste0(outrds,"/fortify.rds"))
...
#bet002_unaligned/filt/nolength: 1949
...
ggsave(paste0(outpath,"/correspond_to_fig5d/upstream_tree.subtree.nolength.pdf"),g_merge,width = 2.52,height = 9.2,units = "cm")
###########
...
ggsave(paste0(outpath,"/correspond_to_fig5c/upstream_tree.subclade.nolength.Marked.pdf"),g2_all_marked,width = 11.6,height = 3,units = "cm")
...
ggsave(paste0(outpath,"/correspond_to_fig5e/entropy_hist.nolength.pdf"),g_hist,width=2.7,height=2.1,units = "cm")

library(brunnermunzel)
t <- brunnermunzel.test(entropy_count_merge.scr$Real,entropy_count_merge.scr$Scramble)
saveRDS(t,paste0(outpath,"/correspond_to_fig5e/entropy_hist.brunnermunzel.nolength.rds"))
...
delsub   <- "~/work/yachie/Konno_FRACTAL/Revise data/data/Yusuke/epPCR_reanalysis/data_for_delsum/bet002_Clade654_nolength_delsub_per_cell.tsv.gz"
ins      <- "~/work/yachie/Konno_FRACTAL/Revise data/data/Yusuke/epPCR_reanalysis/data_for_delsum/bet002_Clade654_nolength_insertion.tsv.gz"
...
ggsave(paste0(outpath,"/correspond_to_fig5f/selectedClade.delsubins.nolength.jpeg"),gmerge_pat,width = 8,height = 14.25,units = "cm",dpi=600)
ggsave(paste0(outpath,"/correspond_to_fig5f/selectedClade.delsubins.nolength.pdf"),gmerge_pat,width = 8,height = 14.25,units = "cm",dpi=600)
