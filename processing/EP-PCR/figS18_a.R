...
outpath <- "~/work/yachie/Konno_FRACTAL/Revise round 1//Figures/FigS17 - PCR/CATNNB_unfiltered//"
outrds <- "~/work/yachie/Konno_FRACTAL/Revise round 1//data/Yusuke/epPCR_reanalysis/RDS/bcat_unfiltered//"
treepath <- "bcat_unaligned//tree/bcat_unaligned.nwk"
...
count_table <-readRDS("bcat_unaligned/dfs_15000/bcat_unaligned_tip15000_15000tipsNode.count_table.rds")
count_long <- readRDS("bcat_unaligned/dfs_15000/bcat_unaligned_tip15000_15000tipsNode.count_long.rds")
tree_list <-  readRDS("bcat_unaligned/dfs_15000/bcat_unaligned_tip15000_tree_list.15000tipsNode.rds")
clade_entropy <- readRDS("bcat_unaligned/dfs_15000/bcat_unaligned_tip15000_15000tipsNode.clade_entropy.rds")
clade_vec <- readRDS("bcat_unaligned/dfs_15000/bcat_unaligned_tip15000_clade_vec.15000tipsNode.rds")
count_exp <- readRDS("bcat_unaligned/dfs_15000/bcat_unaligned_tip15000_tbl_tree_expand.15000tipsNode.rds")
# 
...
rand.color <- readRDS("well.COLORCODE.96.bcat.thick.rds") #for BET002, filtered
...
g2_all <- readRDS("bcat_unaligned////dfs_15000//tree_all_ggplot.rds")
# xlab("Upstream tree")+
...
ggsave(paste0(outpath,"/correspond_to_fig5e/entropy_hist.small.pdf"),g_hist,width=2.7,height=2.1,units = "cm")
ggsave(paste0(outpath,"/correspond_to_fig5e/entropy_hist.mid.pdf"),g_hist,width=5,height=4,units = "cm")
ggsave(paste0(outpath,"/correspond_to_fig5e/entropy_hist.large.pdf"),g_hist,width=9,height=8,units = "cm")
...
delsub   <- "~/work/yachie/Konno_FRACTAL/Revise data/data/Yusuke/epPCR_reanalysis/data_for_delsum/bcat_Clade3115_nolength_delsub_per_cell.tsv.gz"
ins      <- "~/work/yachie/Konno_FRACTAL/Revise data/data/Yusuke/epPCR_reanalysis/data_for_delsum/bcat_Clade3115_nolength_insertion.tsv.gz"
