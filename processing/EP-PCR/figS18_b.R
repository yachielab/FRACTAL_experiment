...
outpath <- "~/work/yachie/Konno_FRACTAL/Revise round 1//Figures/FigS17 - PCR/BET002_unfiltered/"
outrds <- "~/work/yachie/Konno_FRACTAL/Revise round 1//data/Yusuke/epPCR_reanalysis/RDS/bet002_unfiltered//"
treepath <- "bet002_unaligned/tree/bet002_unaligned.nwk"
...
count_table <-readRDS("bet002_unaligned/dfs_15000/bet002_unaligned_tip15000_15000tipsNode.count_table.rds")
count_long <- readRDS("bet002_unaligned/dfs_15000/bet002_unaligned_tip15000_15000tipsNode.count_long.rds")
tree_list <-  readRDS("bet002_unaligned/dfs_15000/bet002_unaligned_tip15000_tree_list.15000tipsNode.rds")
clade_entropy <- readRDS("bet002_unaligned/dfs_15000/bet002_unaligned_tip15000_15000tipsNode.clade_entropy.rds")
clade_vec <- readRDS("bet002_unaligned/dfs_15000/bet002_unaligned_tip15000_clade_vec.15000tipsNode.rds")
count_exp <- readRDS("bet002_unaligned/dfs_15000/bet002_unaligned_tip15000_tbl_tree_expand.15000tipsNode.rds")
# 
...
g_hist <-ggplot(entropy_count_merge.scr.long,aes(x=value,fill=name))+
  ...
  NoLegend()
ggsave(paste0(outpath,"/correspond_to_fig5e/entropy_hist.log.small.pdf"),g_hist,width=2.7,height=2.1,units = "cm")
ggsave(paste0(outpath,"/correspond_to_fig5e/entropy_hist.log.mid.pdf"),g_hist,width=5,height=4,units = "cm")
ggsave(paste0(outpath,"/correspond_to_fig5e/entropy_hist.log.large.pdf"),g_hist,width=9,height=8,units = "cm")
