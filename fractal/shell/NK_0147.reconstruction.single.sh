...
#$ -N NK_0147
#$ -cwd
#$ -o /home/ha5653/backup/YachieLab/ikaken/NK_0147/subclades/reconstruction/out
#$ -e /home/ha5653/backup/YachieLab/ikaken/NK_0147/subclades/reconstruction/err
...
CWD="/home/ha5653/backup/YachieLab/ikaken/NK_0147/subclades/reconstruction"
...
for METHOD in rapidnjNJ raxmlMP fasttreeML; do
    for t in 10000000 $THRESHOLD; do
        for ID in $(seq 0 83); do
            if [ $i -eq ${SGE_TASK_ID} ];then
                ...
                /usr/bin/time -f "%M,KB,%e,sec," FRACTAL -m $METHOD -i FRACTALin.fa.gz -k $SUBSAMPLE -t $t -e 2>&1 1> /dev/null | tr -d "\n" >> ${OUTPUT_DIR}/result.out
